...
public abstract class CollectionTest {
	...
	void performanceAddContainsIteratorTest() {
		...
		if (collection instanceof List) {
			System.out.println("Perfomance test of method \"contains\" for all List objects takes huge time");
		} else {
	...
	@Test
	void removeIfTest() {
		assertTrue(collection.reemoveIf(n -> n % 2 == 0));
		assertTrue(collection.stream().allMatch(n -> n % 2 != 0));
		assertFalse(collection.reemoveIf(n -> n % 2 == 0));
	}
	@Test
	void clearTest() {
		collection.clear();
